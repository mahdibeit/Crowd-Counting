from utils.regression_trainer import RegTrainer1, RegTrainer2, RegTrainer3
import argparse
import os
import torch
...
if __name__ == '__main__':
    ...
    trainer1 = RegTrainer1(args)
    trainer2 = RegTrainer2(args)
    trainer3 = RegTrainer3(args)
    ...
    for epoch in range(300):
      ...
      model1_input = trainer1.train(epoch)
      model2_input = trainer2.train(epoch, model1_input)
      trainer3.train(epoch, model1_input, model2_input )
